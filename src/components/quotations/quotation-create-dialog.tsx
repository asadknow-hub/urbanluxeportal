      ...
      >
        <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-950 p-4 sm:p-5 text-white relative overflow-hidden">
          ...
          <DialogHeader className="relative z-10">
            <DialogTitle className="text-2xl font-bold tracking-tight">Create New Quotation</DialogTitle>
          </DialogHeader>
        </div>
        <form onSubmit={handleSubmit} className="p-4 sm:p-5 space-y-5">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="space-y-2.5">
              <Label htmlFor="valid_until" className="text-[10px] font-bold uppercase tracking-widest text-slate-500">Valid Until</Label>
              <Input
                id="valid_until"
                type="date"
                value={validUntil}
